...
const AccueilContact = () => {
    return (
        <section className="w-full h-50 sm:h-64 lg:h-[70vh] relative " style={{ backgroundImage: `url(${ContactBackground})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
            <div className="w-full sm:w-1/2 text-start px-14 lg:pl-44 py-16 lg:py-32">
                <h2 className="text-white font-bold text-lg md:text-xl lg:text-4xl mb-6">
            ...
            <div className="absolute bottom-0 right-0 left-0 text-center p-1 bg-gray-300 text-[0.57rem] text-[#497b9c] fon4c2t-bold lg:hidden">
                <p>
