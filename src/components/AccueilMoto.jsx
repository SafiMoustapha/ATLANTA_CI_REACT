...
const AccueilCamion = () => {
    return (
        <section>
            <div className="h-64 lg:h-[70vh] relative " style={{ backgroundImage: `url(${bgMoto})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                ...
                <div>
                    <div className="absolute bottom-16 right-0 left-0 text-center p-2 bg-gray-100 text-[0.57rem] text-[#0094c2] font-bold lg:hidden">
                        <p>
                           ATLANTA ASSURANCE vous offre une protection complète pour votre moto, adaptée à votre besoin. Bénéficiez de notre expertise et d'un service client dédié<br/>pour rouler en toute sérénité.
                        </p>
                    </div>
                    {/* Bouton mobile */}
