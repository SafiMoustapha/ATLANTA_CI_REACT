...
const AccueilFAQ = () => {
    return (
        <section className="h-64 lg:h-[70vh] relative" style={{ backgroundImage: `url(${FAQBackground})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
            <div className="w-1/2 text-start px-14 lg:pl-44 py-16 lg:py-32">
                    <h2 className="text-white font-bold text-xl lg:text-4xl lg:mb-6">
                        Les questions les plus <br/><span className="text-[#497b9c]">fréquentes</span>
                    </h2>
