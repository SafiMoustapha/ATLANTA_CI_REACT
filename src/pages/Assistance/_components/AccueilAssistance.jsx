    ...
    return (
        <section>
            <div className="h-64 lg:h-[70vh] relative " style={{backgroundImage:`url(${HeroBackground})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                <div className="w-1/2 text-start px-12 md:px-14 lg:pl-44 py-16 lg:py-32">
                ...
                <div className="absolute bottom-0 right-0 left-0 text-center p-2 md:p-4 bg-gray-300 text-[0.57rem] text-[#497b9c] font-bold lg:hidden">
                    <p>
                        Accédez rapidement à notre support expert disponible 24h/24 et 7j/7, prêt à répondre à toutes vos questions et à vous guider dans la déclaration de votre sinistre, <br className=" hidden sm:flex"/>que ce soit par téléphone ou en ligne.
                    </p>
                </div>
            </div>
        </section>
