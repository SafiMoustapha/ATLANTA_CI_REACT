import bgCamion from "../../../../assets/Bg_camion.jpg"

const AccueilCamion = () => {
    return (
        <section>
            <div className="h-64 lg:h-[76vh] relative " style={{ backgroundImage: `url(${bgCamion})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                <div className="w-1/2 text-start p-5 md:px-12 lg:pl-44 md:py-16 lg:py-18">
                ...
                <div>
                    <div className="absolute bottom-12 md:bottom-16 right-0 left-0 text-center p-2 bg-gray-100 text-[0.57rem] text-[#0094c2] font-bold lg:hidden">
                        <p>
